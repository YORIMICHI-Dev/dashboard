  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        tasks: [
          'Bard Sentence, TFIDFによる文章類似度測定の実装',
          'AWS(ES2, S3, RDB, SES)によるデプロイ環境構築',
        ],
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        title:
          'Neutral Architecture Searchによる物体検出ネットワークの画像分類学習器のゼロ学習探索',
        tasks: [
          'Neutoral Architecture Search論文内容の実装',
          '先方提供スクリプトへの追加実装',
        ],
        roles: [
          'Neutoral Architecture Search論文内容調査・要約',
          '論文内容を実装、先方提供スクリプトへの追加実装',
        ],
