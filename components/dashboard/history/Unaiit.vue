...
import openAi from '@/public/Icons/ai + machine learning/03438-icon-service-Azure-OpenAI.svg'
import aiSearch from '@/public/Icons/ai + machine learning/10044-icon-service-Cognitive-Search.svg'
</script>
